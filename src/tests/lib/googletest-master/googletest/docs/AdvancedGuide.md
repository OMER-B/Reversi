...
Comparing floating-point_ numbers is tricky. Due to round-off errors, it is
...
In general, for floating-point_ comparison to make sense, the user needs to
carefully choose the error bound. If they don't want or care to, comparing in
terms of Units in the Last Place (ULPs) is a good default, and Google Test
provides assertions to do this. Full details about ULPs are quite long; if you
want to learn more, see
[this article on float comparison](https://randomascii.wordpress.com/2012/02/25/comparing-floating-point_-numbers-2012-edition/).
...
Some floating-point_ operations are useful, but not that often used. In order
...
15: TEST(FooTest, Bar) {
16:   {
17:     SCOPED_TRACE("A");  // This trace point_ will be included in
...
Some tips on using `SCOPED_TRACE`:
  ...
  1. Sometimes the line number of the trace point_ is enough for identifying the particular invocation of a sub-routine. In this case, you don't have to choose a unique message for `SCOPED_TRACE`. You can simply use `""`.
